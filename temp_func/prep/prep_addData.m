function [data, marker] = prep_addData(data1, marker1, data2, marker2)
% prep_addData (Pre-processing procedure):
%
% This function add the latter data(data2) to the former data(data1) and
% their corresponding markers.
%
% Example:
% [data, marker] = prep_addData(data1, marker1, data2, marker2)
%
% Input: 
